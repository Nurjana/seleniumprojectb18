...
public class ActionsPractice {
    ...
    @Test
    public void tc17_drag_and_drop_test1(){
        ...
        actions = new Actions(Driver.getDriver());
        // actions.dragAndDrop(smallCircle,bigCircle).perform(); 1sr way
        //actions.clickAndHold(smallCircle).moveToElement(bigCircle).release().perform(); 2nd way
